                        ...
                        items: new OA\Items(
                            ...
                            properties: [
                                new OA\Property(
                                    ...
                                    maxLength: 30,
                                    example: 'PROD-001',
                                    description: 'Unique item code used as the upsert key in Xero.'
                                ),
                                new OA\Property(
                                    property: 'name',
                                    type: 'string',
                                ...
                                new OA\Property(
                                    ...
                                    format: 'float',
                                    example: 50.00,
                                    description: 'Unit sale price (SalesDetails.UnitPrice in Xero).'
                                ),
                                new OA\Property(
                                    property: 'costPrice',
                                    type: 'number',
                                    format: 'float',
                                    example: 35.00,
                                    description: 'Unit cost price (PurchaseDetails.UnitPrice in Xero).'
                                ),
                                new OA\Property(
                                    property: 'salesAccountCode',
                                    type: 'string',
                                    maxLength: 10,
                                    example: '200',
                                    description: 'Xero account code for sales (e.g. Revenue account).'
                                ),
                                new OA\Property(
                                    property: 'purchaseAccountCode',
                                    type: 'string',
                                    maxLength: 10,
                                    example: '310',
                                    description: 'Xero account code for purchases (e.g. COGS account).'
                                )
                            ],
                            type: 'object'
                        )
            ...
            new OA\Response(
                ...
                content: new OA\JsonContent(
                    properties: [
                        ...
                        new OA\Property(property: 'message', type: 'string', example: 'Items synced to Xero successfully.'),
                        new OA\Property(
                            property: 'data',
                            type: 'object',
                            description: 'Raw Xero Items API response.'
                        )
                    ]
                )
            ),
