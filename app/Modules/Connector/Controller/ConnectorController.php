...
class ConnectorController extends Controller
{
     ...
     *             @OA\Property(property="message", type="string", example="Connectors retrieved successfully."),
     *             @OA\Property(
     *                 property="data",
     *                 type="array",
     *                 @OA\Items(
     ...
     *                     @OA\Property(property="name", type="string", example="POS System"),
     *                     @OA\Property(property="active", type="boolean", example=true),
     *                     @OA\Property(property="allowed_events", type="array", nullable=true, @OA\Items(type="string", example="invoice.created")),
     *                     @OA\Property(property="last_used_at", type="string", format="date-time", nullable=true, example="2026-05-19T10:00:00.000000Z"),
     *                     @OA\Property(property="created_at", type="string", format="date-time", example="2026-05-19T08:00:00.000000Z")
     *                 )
     *             ),
     *             @OA\Property(
     *                 property="pagination",
     ...
     *                 @OA\Property(property="organization_id", type="array", @OA\Items(type="string", example="The organization id field is required."))
     *             )
     *         )
     *     ),
     *     @OA\Response(
     ...
     *             @OA\Property(property="organization_id", type="integer", description="ID of the organization this connector belongs to.", example=1),
     *             @OA\Property(property="name", type="string", minLength=3, maxLength=255, description="Unique name within the organization.", example="POS System"),
     *             @OA\Property(
     *                 property="allowed_events",
     *                 type="array",
     *                 nullable=true,
     *                 description="List of event types this connector is allowed to send. Null means all events are allowed.",
     *                 @OA\Items(type="string", example="invoice.created")
     *             ),
     *             @OA\Property(property="active", type="boolean", description="Whether the connector is active. Defaults to true.", example=true)
     *         )
     *     ),
     *     @OA\Response(
     *         response=201,
     ...
     *         @OA\JsonContent(
     *             @OA\Property(property="success", type="boolean", example=true),
     *             @OA\Property(property="message", type="string", example="Connector created successfully."),
     *             @OA\Property(
     *                 property="data",
     *                 type="object",
     *                 @OA\Property(property="id", type="integer", example=1),
     ...
     *                 @OA\Property(property="active", type="boolean", example=true),
     *                 @OA\Property(property="allowed_events", type="array", nullable=true, @OA\Items(type="string", example="invoice.created")),
     *                 @OA\Property(property="last_used_at", type="string", nullable=true, example=null),
     *                 @OA\Property(property="token", type="string", description="Bearer token — only visible at creation.", example="a3f1c2e4d5b6a7f8c9e0d1b2a3f4c5e6"),
     *                 @OA\Property(property="created_at", type="string", format="date-time", example="2026-05-19T08:00:00.000000Z")
     *             )
     *         )
     *     ),
     ...
     *         @OA\JsonContent(
     *             @OA\Property(property="success", type="boolean", example=false),
     *             @OA\Property(property="message", type="string", example="A connector with the same name already exists in this organization."),
     *             @OA\Property(property="data", type="array", @OA\Items())
     *         )
     *     ),
     *     @OA\Response(
     ...
     *         @OA\JsonContent(
     *             @OA\Property(property="success", type="boolean", example=true),
     *             @OA\Property(property="message", type="string", example="Connector retrieved successfully."),
     *             @OA\Property(
     *                 property="data",
     *                 type="object",
     *                 @OA\Property(property="id", type="integer", example=1),
     ...
     *                 @OA\Property(property="active", type="boolean", example=true),
     *                 @OA\Property(property="allowed_events", type="array", nullable=true, @OA\Items(type="string", example="invoice.created")),
     *                 @OA\Property(property="last_used_at", type="string", format="date-time", nullable=true, example=null),
     *                 @OA\Property(property="created_at", type="string", format="date-time", example="2026-05-19T08:00:00.000000Z")
     *             )
     *         )
     *     ),
     ...
     *         @OA\JsonContent(
     *             @OA\Property(property="success", type="boolean", example=false),
     *             @OA\Property(property="message", type="string", example="Connector not found with ID: 99"),
     *             @OA\Property(property="data", type="array", @OA\Items())
     *         )
     *     ),
     *     @OA\Response(
     ...
     *             @OA\Property(property="name", type="string", minLength=3, maxLength=255, description="New name. Must be unique within the organization.", example="Updated POS System"),
     *             @OA\Property(
     *                 property="allowed_events",
     *                 type="array",
     *                 nullable=true,
     *                 description="Updated list of allowed event types. Send null to allow all events.",
     *                 @OA\Items(type="string", example="invoice.created")
     *             ),
     *             @OA\Property(property="active", type="boolean", description="Whether the connector is active.", example=true)
     *         )
     *     ),
     *     @OA\Response(
     *         response=200,
     ...
     *         @OA\JsonContent(
     *             @OA\Property(property="success", type="boolean", example=true),
     *             @OA\Property(property="message", type="string", example="Connector updated successfully."),
     *             @OA\Property(
     *                 property="data",
     *                 type="object",
     *                 @OA\Property(property="id", type="integer", example=1),
     *                 @OA\Property(property="organization_id", type="integer", example=1),
     *                 @OA\Property(property="name", type="string", example="Updated POS System"),
     *                 @OA\Property(property="active", type="boolean", example=true),
     *                 @OA\Property(property="allowed_events", type="array", nullable=true, @OA\Items(type="string", example="invoice.created")),
     *                 @OA\Property(property="last_used_at", type="string", format="date-time", nullable=true, example=null),
     *                 @OA\Property(property="created_at", type="string", format="date-time", example="2026-05-19T08:00:00.000000Z")
     ...
     *         @OA\JsonContent(
     *             @OA\Property(property="success", type="boolean", example=true),
     *             @OA\Property(property="message", type="string", example="Connector deleted successfully."),
     *             @OA\Property(property="data", type="array", @OA\Items())
     *         )
     *     ),
     *     @OA\Response(
